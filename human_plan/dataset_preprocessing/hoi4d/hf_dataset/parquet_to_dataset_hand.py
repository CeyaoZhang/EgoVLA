...
if __name__ == "__main__":
  ...
  # Example usage
  dataset_file_root = f"data/hoi4d_hf/HF_hand_{args.additional_tag}_{set_label}"

  parquet_pattern = f"data/hoi4d_hf/hand_{args.additional_tag}_{set_label}_parquets/*.parquet"
