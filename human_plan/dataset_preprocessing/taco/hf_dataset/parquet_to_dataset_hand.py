...
if __name__ == "__main__":
  ...
  # Example usage
  dataset_file_root = f"data/TACO_HF/HF_hand_{args.additional_tag}_{set_label}"
  parquet_pattern = f"data/TACO_HF/hand_{args.additional_tag}_{set_label}_parquets/*.parquet"
